...
def build_runtime_config(voice_cfg: Any) -> VoiceRuntimeConfig:
    ...
    tts = TTSProviderConfig(
        ...
        gpt_sovits_root_dir=str(getattr(voice_cfg, "gpt_sovits_root_dir", "") or ""),
        ...
        gpt_sovits_segmentation_mode=str(getattr(voice_cfg, "gpt_sovits_segmentation_mode", "cut5") or "cut5"),
